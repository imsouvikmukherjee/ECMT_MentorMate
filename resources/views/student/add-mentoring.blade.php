...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    <div class="breadcrumb-title pe-3">Add Mentoring Information</div>
    <div class="ps-3">
...
<div class="card mentoring-card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="mb-1">Add Mentoring Information</h4>
                <p class="text-muted mb-0">Add your academic journey information</p>
            </div>
        </div>
    ...
    <div>
        Please verify the subjects and paper codes as per the selected semester before submitting the mentoring information.
    </div>
</div>


        <form action="{{ route('add_mentoring_store') }}" method="POST">
            @csrf
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row">
            ...
            {{-- <div class="main-tab-content"> --}}
                <div class="tab-content" id="mainTabsContent">
                    {{-- @for($i = 1; $i <= 8; $i++) --}}
                        ...
                        <div class="card mb-4" id="academic-development-card" style="display: none;">
                        ...
                        <div class="mb-4" id="practical-section" style="display: none;">
                            <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="table-responsive mt-3">
                                <table class="table table-bordered" id="practical-table">
                                    ...
                                    <tbody id="practical-tbody">
                                        ...
                                        <tr>
                                            <td><input type="text" class="form-control" name="practical_subject[]" value="" placeholder="Subject Name"></td>
                                            <td><input type="text" class="form-control" name="practical_code[]" value="" placeholder="e.g. CSCP101"></td>
                                            <td><input type="number" class="form-control table-input" name="pca1[]" value="" min="0" max="40" placeholder="0-40"></td>
                                            <td><input type="number" class="form-control table-input" name="pca2[]" value="" min="0" max="40" placeholder="0-40"></td>
                                            {{-- <td>
                        ...
                        <div class="mb-4" id="semester-section" style="display: none;">
                            <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="table-responsive mt-3">
                                <table class="table table-bordered" id="semester-table">
                                    ...
                                    <tbody id="semester-tbody">
                                        ...
                                        <tr>
                                            <td><input type="text" class="form-control" name="semester_subject[]" value="" placeholder="Subject Name"></td>
                                            <td><input type="text" class="form-control" name="semester_subject_code[]" value="" placeholder="e.g. BCAC501"></td>
                                            ...
                                            <td><input type="number" class="form-control table-input" name="semester_points[]" value="" min="0" max="10" placeholder="0-10"></td>
                                            <td><input type="number" class="form-control table-input" name="semester_credit[]" value="" step="0.5" min="0" placeholder="e.g. 4.0"></td>
                                            <td><input type="number" class="form-control table-input" name="semester_credit_points[]" value="" step="0.5" min="0" placeholder="e.g. 40"></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <input type="number" class="form-control" name="sgpa" value="{{old('sgpa')}}" step="0.01" min="0" max="10" placeholder="e.g. 8.92">
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
                        ...
                        <div class="mb-4" id="attendance-section" style="display: none;">
                            <div class="d-flex justify-content-between align-items-center">
    ...
    @if(old('attendance_subject'))
        @foreach(old('attendance_subject') as $index => $subject)
            <tr>
                <td class="subject-column">
                    <input type="text" class="form-control" name="attendance_subject[]" value="{{ $subject }}" placeholder="Subject Name (Code)">
                </td>
                @foreach(['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'] as $month)
                    <td>
                        <input type="number" class="form-control table-input" name="{{ $month }}[]"
                            value="{{ old($month)[$index] ?? '' }}"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="certifications" rows="3" placeholder="List your certifications">{{old('certifications')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="workshops" rows="3" placeholder="List your workshops">{{old('workshops')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="competitions" rows="3" placeholder="List your participated competitions">{{old('competitions')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="projects" rows="3" placeholder="Academic/Personal Projects">{{old('projects')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div id="body-language-container">
        @php
            $oldTypes = old('body_language_type', $bodyLanguageTypes ?? []);
            $oldValues = old('body_language_value', $bodyLanguageValues ?? []);
        @endphp

        @if(count($oldTypes) > 0)
            @foreach($oldTypes as $index => $type)
                <div class="row mb-2 body-language-row">
                    <div class="col-12">
                        <div class="d-flex flex-column flex-sm-row gap-2">
                            <select class="form-select" name="body_language_type[]">
                                <option value="" disabled {{ $type == '' ? 'selected' : '' }}>Select Body Language</option>
                                @foreach(['Eye Contact','Nervous','Lazy','Smiling','Open Posture','Leaning In','Firm Handshake','Upbeat Body Movements','Avoidance of Eye Contact','Crossed Arms','Fidgeting','Poor Posture','Staring at One\'s Phone','Yawning','Weak Handshake','Shrugging'] as $option)
                            ...
                            <select class="form-select" name="body_language_value[]" style="max-width: 120px;">
                                <option value="Yes" {{ ($oldValues[$index] ?? '') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ ($oldValues[$index] ?? '') == 'No' ? 'selected' : '' }}>No</option>
                            </select>
        ...
        <i class="bi bi-plus-circle me-1"></i>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="sports_participation" value="{{old('sports_participation')}}" placeholder="List extra curricular activities">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Cultural Activities</label>
                                        <input type="text" class="form-control" name="cultural_activities" value="{{old('cultural_activities')}}" placeholder="List cultural activities">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Club Memberships</label>
                                        <input type="text" class="form-control" name="club_memberships" value="{{old('club_memberships')}}" placeholder="List club memberships">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="social_service_activities" rows="2" placeholder="Describe social service activities">{{old('social_service_activities')}}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Community Engagement</label>
                                        <textarea class="form-control" name="community_engagement" rows="2" placeholder="Describe community engagement">{{old('community_engagement')}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="d-flex flex-column flex-sm-row gap-2 mt-3 mt-md-0">
                            <select class="form-select flex-grow-1" name="language_proficiency[]">
                                ...
                                <option value="Fluent">Fluent</option>
                                <option value="Good">Good</option>
                                <option value="Stammering">Stemmering</option>
                                <option value="Fumbles">Fumbles</option>
                            </select>
                            <button type="button" class="btn text-danger remove-language-btn btn-sm">
                                <i class="bi bi-trash"></i>

    ...
    <div class="wrapper">
        ...
        <div class="sidebar-wrapper" data-simplebar="true">
            ...
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('user.mentoring') }}">
                        <div class="parent-icon"><i class='bx bx-book-open'></i>
                        </div>
                        <div class="menu-title">Mentoring Info</div>
                    </a>
                </li>
            </ul>
            <!--end navigation-->
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          ...
                          @if ($student->user_image == null)
                                <img src="{{url('admin-assets/images/avatars/avatar4.png')}}" class="user-img" alt="user avatar">
                          @else
                                <img src="{{asset('img/'.$student->user_image)}}" class="user-img" alt="user avatar">
                          @endif
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="{{ route('user_profile') }}"><i class="bx bx-user"></i><span>Profile</span></a>
                            </li>
                            <li>
